  ...
  //Medicine Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        $.ajax({
          ...
          modal.find('.modal-title').text('Medicine Update');
          $.ajax({
          type: "GET",
          url: "ModalMedicineUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
