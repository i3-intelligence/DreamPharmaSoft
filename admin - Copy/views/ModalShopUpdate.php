...
<div class="card-body">
  ...
  <div class="col-md-6">
      ...
      <!-- input states -->
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Shop Contact No.</label>
        <input type="text" class="form-control"  id="ShopContact" value="<?php print $ShopContact; ?>"
  ...
  <div class="modal-footer">
    ...
    <input type="button" id="UpdateShop" onclick="UpdateShop();" value="Update Data" class="btn btn-warning">
  </div>
