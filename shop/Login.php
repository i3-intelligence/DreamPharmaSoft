        ...
        <div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-gray-100 ">
            ...
            <div class="relative sm:max-w-sm w-full mt-20">
                ...
                <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                    ...
                    <form role="form" action="LoginExecute.php" method="post">
                    <input type="hidden" name="CSRF_token" value="<?php print $_SESSION['CSRF']; ?>">
                        <div>
                            <input type="text" placeholder="Phone" required name="Phone"
                                class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" value="<?php if(!empty($_COOKIE['Phone'])){ print $_COOKIE['Phone']; }?>">
                        </div>
                        ...
                        <div class="mt-7">
                            <input type="checkbox" <?php if(!empty($_COOKIE['Phone']) && !empty($_COOKIE['Password'])){ print "Checked"; } ?> name="reFetchLoginData" id="reFetchLoginData" class="inline-block mr-2">
...
<script type="text/javascript">
    ...
    // Close the dropdown menu if the Phone clicks outside of it
...
Swal.fire({
    ...
    icon: 'error',
    title: 'Login Failed !',
    footer: 'Please Check Your Phone Number And Password.',
    animation: true,
    position: 'top',
    showConfirmButton: false,
    timer: 4000,
