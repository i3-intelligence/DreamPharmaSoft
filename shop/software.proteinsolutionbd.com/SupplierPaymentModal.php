...
<div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <input type="button" id="Delete" onclick="SupplierPaymentDelete();" value="Delete" class="btn btn-danger">
        </div>
    </div>
</div>
</div>
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Wallet Payment </h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <input type="button" id="WalletPayment" onclick="WalletPayment();" value="Wallet Payment" class="btn btn-info">
            </div>
        </div>
    </div>
</div>
