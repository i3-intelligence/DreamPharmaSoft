...
if(MenuPermission('2',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Supplier Category View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Supplier Category Add </h4>
          </div>
  ...
  //Supplier CategoryAdd
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='SupplierCategory'){
          ...
          modal.find('.modal-title').text('Supplier Category Add');
        ...
        $.ajax({
          ...
          modal.find('.modal-title').text('Supplier Category Update');
          $.ajax({
          type: "GET",
