...
if(MenuPermission('29',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Wallet Ledger"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="WalletLedgerView.php" method="get" target="_blank">
                      ...
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><span class="material-icons"
                              title="Required Field">error</span>Wallet </span>
                        </div>


                        <select class="form-control select2" id="WalletID" name="WalletID">
                          <option value="All">All Wallet</option>
                          <?php $query = $conn->prepare("SELECT * FROM `Wallet` WHERE `Status` = 'Active'ORDER BY `Name` ASC "); 
$query->execute();
$fetch_list = $query->fetchAll(PDO::FETCH_ASSOC);
foreach($fetch_list AS $fetch) { ?>
                          <option value="<?php Print $fetch['WalletID']; ?>"><?php Print $fetch['WalletID']; ?>
