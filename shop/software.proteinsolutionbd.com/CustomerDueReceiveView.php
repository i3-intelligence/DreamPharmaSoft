...
<?php
$discount = 0;
$query = $conn->prepare("SELECT * FROM `Receive`  
WHERE `CustomerDueReceiveInvoice` = '$_GET[CustomerDueReceiveInvoice]'"); 
$query->execute();
$fetch = $query->fetch(PDO::FETCH_ASSOC);

$query1 = $conn->prepare("SELECT CONCAT('Customer ID: 00',CustomerID,'<br> ','Customer Name: ',`Name`,'<br> ','Address: ',`Address`,'<br> ','Mobile: ',`MobileNo`) AS `cust_info` FROM `Customer` WHERE `CustomerID` = '$fetch[CustomerID]'"); 
$query1->execute();
	...
	<div id="page-wrap">
		...
		<div class="container">
			...
			<p><font style="font-size:16px;">বিসমিল্লাহির রাহমানির রাহীম</font><br><font style="font-size:30px;"> <b><?php print $company; ?> </b></font><br>
				...
				<font style="margin-top:4%;margin-left: -4%;"> <b>Customer Copy</b> </font>
		</div>	

		<center> <h2>CUSTOMER DUE</h2> </center>
		...
		<div id="identity" style="border:0px solid; width:100%; float:left;">
           ...
           <table id="meta" style="width: 250px;">
                ...
                <tr>
                    ...
                    <td style="border: none;text-align: left;font-size:15px;padding: 0px;"><b><?php print $fetch['ReceiveDate']; ?></b></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border: none;text-align: left;font-size:15px;padding: 0px;"><b><?php print $fetch['CustomerDueReceiveInvoice']; ?></b></td>
                </tr>
		...
		<table id="items">
		 ...
		 <tr>
		  ...
		  <tr>
		      <td colspan="2" class="total-line balance" style="text-align:center;width:80%;"><b>Receive</b> <?php print $fetch['PaymentName']; ?>  </td>
		      <td style="text-align:center;width:20%;" class="total-value balance"><div class="due"> <b><?php print $fetch['ReceiveAmount']; ?></b> </div></td>
		  </tr>
		  ...
		  <!-- <tr>
			 ...
			 <b>In Words:   <?php
            // $ReceiveAmount = number_format($fetch['ReceiveAmount'], ((int) $fetch['ReceiveAmount'] == $fetch['ReceiveAmount'] ? 0 : 2), '.', ','); 
	
			// 		print convert_number_to_words((int)$ReceiveAmount);
        ...
        <div id="terms" style="margin-top: 5px; margin-bottom: 70px; font-size: 12px;">
		  <b>Remarks: <?php print $fetch['ReceiveNote']; ?></b>
		</div>
