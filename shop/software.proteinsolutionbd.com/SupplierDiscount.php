        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?php print $PageLevel = "Supplier  Discount"; ?></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <!-- input states -->
                                    <!-- <div class="form-group">
                                        <label class="col-form-label" for="inputSuccess"> Payment Amount </label>
                            ...
                            <div class="col-md-6">
                                    <!-- input states -->
                                    <div class="form-group">
                                        <label class="col-form-label" for="inputSuccess">Discount Amount <small class="badge badge-warning" id="pay_mode"> </small></label>
                            ...
                            <div class="col-md-6">
                                    <!-- input states -->
                                    <div class="form-group">
                                        <label class="col-form-label" for="inputSuccess">Supplier  Discount Invoice</label>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="button" class="btn btn-success float-right" onclick="SupplierPayment();" id="SupplierPayment" value="Supplier  Discount">
                                    </div>
