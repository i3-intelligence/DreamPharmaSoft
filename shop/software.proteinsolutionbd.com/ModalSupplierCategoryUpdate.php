...
<div class="card-body">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Supplier Category Name</label>
    ...
    <div class="col-md-6">
      <!-- input states -->
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Supplier Category Id</label>
  ...
  <div class="modal-footer">
    ...
    <input type="button" id="UpdateSupplierCategory" onclick="UpdateSupplierCategory();" value="Update Data" class="btn btn-success">
  </div>
