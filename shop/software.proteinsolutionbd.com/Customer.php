    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Customer View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Customer">Add New</button></li>
  ...
  //Customer Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Customer'){
          ...
          modal.find('.modal-title').text('Customer Add');
       
        $.ajax({
          type: "GET",
          url: "ModalCustomerInsert.php",
          data: dataString,
          cache: false,
          ...
          modal.find('.modal-title').text('Customer Update');
          $.ajax({
          type: "GET",
          url: "ModalCustomerUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
