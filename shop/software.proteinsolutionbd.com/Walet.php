    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Walet View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Walet Add </h4>
          </div>
  ...
  //Customer CategoryAdd
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='SupplierCategory'){
          ...
          modal.find('.modal-title').text('Walet Add');
        ...
        $.ajax({
          ...
          modal.find('.modal-title').text('Walet Update');
          $.ajax({
          type: "GET",
