...
if(MenuPermission('13',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Others Account View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Others Account">Add New</button></li>
          ...
          <div class="card card-default">
            ...
            <div class="card">
              ...
              <div class="card-body" id="LoadCartList">
                ...
                <?php include("OthersAccountList.php"); ?>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Others Account Add </h4>
          </div>
...
<script>
  ...
  //Customer CategoryAdd
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Others Account'){

          modal.find('.modal-title').text('Others Account Add');
       
        $.ajax({
          type: "GET",
          url: "ModalOthersAccountInsert.php",
          data: dataString,
          cache: false,
      ...
      }else if (ID !='OthersAccount'){

          modal.find('.modal-title').text('Others Account Update');
          $.ajax({
          type: "GET",
          url: "ModalOthersAccountUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
