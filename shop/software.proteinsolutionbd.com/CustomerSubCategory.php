...
if(MenuPermission('7',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Customer Sub Category View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="CustomerSubCategory">Add New</button></li>
          ...
          <div class="card card-default">
            ...
            <div class="card">
              ...
              <div class="card-body" id="LoadCartList">
                ...
                <?php include("CustomerSubCategoryList.php"); ?>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Customer Sub Category Add </h4>
          </div>
...
<script>
  ...
  //Customer Sub Category Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='CustomerSubCategory'){

          modal.find('.modal-title').text('Customer Sub Category Add');
       
        $.ajax({
          type: "GET",
          url: "ModalCustomerSubCategoryInsert.php",
          data: dataString,
          cache: false,
      ...
      }else if (ID !='CustomerSubCategory'){

          modal.find('.modal-title').text('Customer Sub Category Update');
          $.ajax({
          type: "GET",
          url: "ModalCustomerSubCategoryUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
