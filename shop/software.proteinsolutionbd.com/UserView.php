...
if(MenuPermission('30',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "User View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="User">Add New</button></li> -->
                  <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                  <li class="breadcrumb-item"><a href="Report.php">Report Menu</a></li>
  ...
  //UserAdd
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='User'){
          ...
          modal.find('.modal-title').text('User Add');
       
        $.ajax({
          type: "GET",
          url: "ModalUserInsert.php",
          data: dataString,
          cache: false,
          ...
          modal.find('.modal-title').text('User Update');
          $.ajax({
          type: "GET",
          url: "ModalUserUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
