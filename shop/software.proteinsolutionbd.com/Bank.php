...
if(MenuPermission('12',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Bank View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Bank">Add New</button></li>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Bank Add </h4>
          </div>
  ...
  //Customer CategoryAdd
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Bank'){
          ...
          modal.find('.modal-title').text('Bank Add');
       
        $.ajax({
          type: "GET",
          url: "ModalBankInsert.php",
          data: dataString,
          cache: false,
          ...
          modal.find('.modal-title').text('Bank Update');
          $.ajax({
          type: "GET",
          url: "ModalBankUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
