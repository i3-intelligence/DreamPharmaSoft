...
<table id="example2" class="table table-bordered table-striped">
  <thead>
      <tr>
            <th colspan="10" style="text-align: center; color:blue;">Last 100 Customer Receive Entry</th>
      </tr>
    <tr>
      <th>SL</th>
      <th>Customer Info.</th>
...
WHERE A.`ReceiveType` = 'Customer Receive' AND A.`EntryID` ='$SessionID'  ORDER BY A.`ReceiveID` DESC  LIMIT 100"); 
$query->execute();
...
?>
    <tr>
      ...
      <th style="text-align: center;"><a title="Click here To Open Invoice" data-toggle="tooltip" onclick="window.open('CustomerReceiveView.php?CustomerReceiveInvoice=<?php echo $fetch['CustomerReceiveInvoice']; ?>', 'Srarch View','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=1,resizable=yes,copyhistory=no,width=800,height=800');"
          style="cursor: pointer;"><?php Print $fetch['CustomerReceiveInvoice']; ?></a></th>
