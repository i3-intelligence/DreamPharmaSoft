...
if(MenuPermission('9',$conn,$SessionID) == 0){ 
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?php print $PageLevel = "Purchase Rate Setup"; ?>
                                <?php if((!empty($_GET['msg']) && $_GET['msg']=='success')){ ?>
                                <small class="badge badge-success">Purchase Rate Added Successful</small>
                                <?php } ?>
                                <?php if((!empty($_GET['msg']) && $_GET['msg']=='error')){ ?>
                                <small class="badge badge-danger">Purchase Rate Added Failed</small>
                                <?php } ?>
                                <?php if((!empty($_GET['msg']) && $_GET['msg']=='update')){ ?>
                                <small class="badge badge-warning">Purchase Rate Update Successful</small>
                                <?php } ?>
                                <?php if((!empty($_GET['msg']) && $_GET['msg']=='delete_success')){ ?>
                                <small class="badge badge-danger">Purchase Rate Delete Successful</small>
                                <?php } ?>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="PurchaseRate.php" method="Post">
                        <!-- Info boxes -->
...
?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control select2" id="SupplierCategory"
                ...
                <!-- /.content-wrapper -->
                <form action="PurchaseRateAction.php" method="post">
...
WHERE A.`SupplierID`='$SupplierID' AND A.`ItemCategoryID`='$ItemCategoryID' AND A.`status` = 'Active'  ORDER BY A.`Thickness` ASC");
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" id="LoadCartList">
                                ...
                                <?php include("PurchaseRateList.php"); ?>
