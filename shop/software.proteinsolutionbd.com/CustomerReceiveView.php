...
WHERE `CustomerReceiveInvoice` = '$_GET[CustomerReceiveInvoice]'"); 
$query->execute();
...
?>
	...
	<div id="page-wrap">
		...
		<center> <h2>CUSTOMER RECEIVE</h2> </center>
		...
		<div id="identity" style="border:0px solid; width:100%; float:left;">
           ...
           <table id="meta" style="width: 250px;">
                ...
                <tr>
                    ...
                    <td style="border: none;text-align: left;font-size:15px;padding: 0px;"><b><?php print $fetch['CustomerReceiveInvoice']; ?></b></td>
                </tr>
