...
if(MenuPermission('24',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Profit/Loss Report"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="ProfitLossReportView.php" method="get" target="_blank">
            <div class="card card-default">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h3 class="card-title">
                  Profit/Loss Customer Wise Report
                </h3>
...
?>
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="ProfitLossSupplierCategoryReportView.php" method="get" target="_blank">
            <div class="card card-default">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h3 class="card-title">
...
foreach($fetch_list AS $fetch) { ?>
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="ProfitLossCustomerCategoryReportView.php" method="get" target="_blank">
            <div class="card card-default">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h3 class="card-title">
                  Profit/Loss Customer Sub Category Wise Report
                </h3>
