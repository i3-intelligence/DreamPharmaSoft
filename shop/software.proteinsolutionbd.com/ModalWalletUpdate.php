...
<div class="card-body">
  ...
  <div class="col-md-6">
      ...
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Wallet Id</label>
  ...
  <div class="modal-footer">
    ...
    <input type="button" id="UpdateWallet" onclick="UpdateWallet();" value="Update Data" class="btn btn-success">
  </div>
