    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Stock Report"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="SupplierWiseStockReport.php" method="get" target="_blank">
...
foreach($fetch_list AS $fetch) { ?>
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="SupplierChallanStockReport.php" method="get" target="_blank">
            <div class="card card-default">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h3 class="card-title">Stock Report Challan Wise</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
...
foreach($fetch_list AS $fetch) { ?>
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="LowStockReport.php" method="get" target="_blank">
            <div class="card card-default">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
