...
{
    $sql .= " ORDER BY `Name`,LPAD(`WalletID`, 3, '0') ASC";
}
...
foreach($result as $fetch)
{
    ...
    $sub_array[] = html_entity_decode(sprintf("%03d",$fetch["WalletID"]));
    $sub_array[] = html_entity_decode($fetch["WalletName"]);
