...
if(MenuPermission('4',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Item Category View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Item Category">Add New</button></li>
          ...
          <div class="card card-default">
            ...
            <div class="card">
              ...
              <div class="card-body" id="LoadCartList">
                ...
                <?php include("ItemCategoryList.php"); ?>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Item Category Add </h4>
          </div>
  ...
  //Item Category Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Item Category'){
          ...
          modal.find('.modal-title').text('Item Category Add');
       
        $.ajax({
          type: "GET",
          url: "ModalItemCategoryInsert.php",
          data: dataString,
          cache: false,
          ...
          modal.find('.modal-title').text('Item Category Update');
          $.ajax({
          type: "GET",
          url: "ModalItemCategoryUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
