...
<div class="card-body">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Customer Category Name</label>
    ...
    <div class="col-md-6">
      <!-- input states -->
      <div class="form-group">
        <label class="col-form-label" for="inputSuccess">Customer Category Id</label>
  ...
  <div class="modal-footer">
    ...
    <input type="button" id="UpdateCustomerCategory" onclick="UpdateCustomerCategory();" value="Update Data" class="btn btn-success">
  </div>
