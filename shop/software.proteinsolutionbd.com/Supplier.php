...
if(MenuPermission('3',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Supplier View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Supplier">Add New</button></li>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Supplier Add </h4>
          </div>
  ...
  //Supplier Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Supplier'){
          ...
          modal.find('.modal-title').text('Supplier Add');
       
        $.ajax({
          type: "GET",
          url: "ModalSupplierInsert.php",
          data: dataString,
          cache: false,
          ...
          modal.find('.modal-title').text('Supplier Update');
          $.ajax({
          type: "GET",
          url: "ModalSupplierUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
