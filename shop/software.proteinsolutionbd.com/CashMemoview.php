...
<?php		
$QurryInvoice = $conn->prepare("SELECT * FROM `CashMemo` WHERE `CashMemoInvoice` = '$_GET[CashMemoInvoice]' ");
...
?>
	...
	<div id="page-wrap">
		...
		<textarea readonly="readonly" id="header"> CASH MEMO </textarea>
		...
		<div id="identity" style="border:0px solid; width:800px; float:left;">
           ...
           <table id="meta">
                ...
                <tr>
                    ...
                    <td><?php Print date("d-m-Y",strtotime($Fetch['CashMemoDate'])); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><b><?php print $CashMemoInvoice; ?></b></td>
                </tr>
...
WHERE A.`CashMemoInvoice`='$CashMemoInvoice' ORDER BY `CashMemoID` ASC ");
...
$SalesAmount += $Fetch['SalesAmount'];
		  ...
		  <tr>
		      ...
		      <td style="text-align:right;" class="total-value"><div id="total"> <?php print number_format($Fetch['PreviousBalance'],2,'.',''); ?> </div></td>
		  </tr>
		  
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line">Net Total:</td>
		      <td style="text-align:right;" class="total-value"><div id="total"> <?php print number_format($Fetch['PreviousBalance'] + $SalesAmount,2,'.',''); ?> </div></td>
		  </tr>
		  
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance">Paid:</td>
		      <td style="text-align:right;" class="total-value balance"><div class="due"> <?php print number_format($Fetch['ReceiveAmount'],2,'.',''); ?> </div></td>
		  </tr>

		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance">Discount:</td>
		      <td style="text-align:right;" class="total-value balance"><div class="due"> <?php print number_format($Fetch['Discount'],2,'.',''); ?> </div></td>
		  </tr>
		  
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance">Balance Due: </td>
		      <td style="text-align:right;" class="total-value balance"><div class="due"> <?php print number_format($Fetch['TotalDue'],2,'.',''); ?> </div></td>
		  </tr>
