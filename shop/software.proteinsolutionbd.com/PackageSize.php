...
if(MenuPermission('5',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Package Size View"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="card card-default">
            ...
            <div class="card">
              ...
              <div class="card-body" id="LoadCartList">
                ...
                <?php include("PackageSizeList.php"); ?>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"> Package Size Add </h4>
          </div>
  ...
  //Package Size Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Package Size'){
          ...
          modal.find('.modal-title').text('Package Size Add');
       
        $.ajax({
          type: "GET",
          url: "ModalPackageSizeInsert.php",
          data: dataString,
          cache: false,
      ...
      }else if (ID !='Package Size'){

          modal.find('.modal-title').text('Package Size Update');
          $.ajax({
          type: "GET",
          url: "ModalPackageSizeUpdate.php",
          data: dataString,
          cache: false,
          success: function (data) {
            console.log(data);
