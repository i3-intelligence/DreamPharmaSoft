...
<tr>
	<th style="text-align:center; font-size:18px;"> Customer Ledger</th>
</tr>
...
<tr>
	<th colspan="11" style="text-align:center;"> Opening Balance / Previous  Balance </th>
...
?>
    ...
    <td style="text-align:right;"> <?php print number_format($fetch['InvoiceAmount'],2,'.',''); ?> </td>
...
$InvoiceAmount += $fetch['InvoiceAmount'];
$Discount += $fetch['Discount'];
$ReceiveAmount += $fetch['ReceiveAmount'];
...
<tr>
	...
	<th></th>
	<th style="text-align:right;"> <?php print number_format($InvoiceAmount,2,'.',''); ?></th>
	<th style="text-align:right;"> <?php print number_format($Discount,2,'.',''); ?></th>
	<th style="text-align:right;"> <?php print number_format($ReceiveAmount,2,'.',''); ?></th>
...
<tr>
	<th style="text-align:center; font-size:18px;"> Customer Balance Summary(<?php print $_GET['CustomerID']; ?>)</th>
</tr>
