...
function formatOutput (optionElement) {
  ...
  return $state;
    ...
    $('#start_date').datetimepicker({
      format: 'DD/MM/YYYY',
      minDate:'<?php print date("m-d-Y",strtotime($ShopCreateDate));?>'
    });
  ...
  window.addEventListener('load', function () {
    ...
    function updateOnlineStatus(event) {
      ...
      if (condition == "online") {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Dear, <?php print $fetch_operator['UserName']; ?> You Are Back In  Online!',
        ...
        Swal.fire({
          icon: 'error',
          title: 'Oops...',
          text: 'Dear, <?php print $fetch_operator['UserName']; ?> You are In Offline!',
