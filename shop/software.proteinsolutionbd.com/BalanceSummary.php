...
if(MenuPermission('33',$conn,$SessionID) == 0){ 
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"><?php print $PageLevel = "Balance Summary"; ?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <!-- Info boxes -->
          <form action="BalanceSummaryView.php" method="get" target="_blank">
                        ...
                        <div class="input-group date" id="end_date" data-target-input="nearest">
                          <div class="input-group-prepend">
                            <span class="input-group-text"><span class="material-icons"
                                title="Required Field">error</span> Date </span>
                          </div>
                          <input type="text" required class="form-control datetimepicker-input" name="end_date"
                            value="<?php print date("01-m-Y",strtotime($CurrentDate));?>"  data-target="#end_date"
